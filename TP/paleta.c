...
const pixel_t tesela[][5] = { 
        {0x94,0x95,0x95,0x95,0x96}, 
        {0x97,0x98,0x99,0x9A,0x9B}, //texto
        {0x9C,0x9D,0x9D,0x9D,0x9E},                                                    
};

const pixel_t score[][7] = {
        {0xb0, 0xb1,0xb1,0xb1,0xb1,0xb1,0xb2}, // borde superior
        {0xb3,0xb4,0xb5,0xb6,0xb7,0xb8,0xb9}, // texto
        {0xba,0xbb,0xbb,0xbb,0xbb,0xbb, 0xbc},// borde inferior
};

const pixel_t time[][6] = {
...
const pixel_t colores_ruta[4][16] = {
        ...
        {0xfff, 0xfff, 0x566, 0xfff,
        0x666, 0x666, 0x566, 0x566,
        0xfff, 0xfff, 0x666, 0xfff, // mitad de la ruta para la pantalla
        0xfff, 0xfff, 0xfff, 0xfff},  // lineas laterales y del medio

        {0xb00, 0xb00, 0x566, 0xb00,
        0xfff, 0xfff, 0xfff, 0xfff,  //   parece good
        0xb00, 0x566, 0x566, 0xb00,
        0xfff, 0xfff, 0xfff, 0xfff},

        {0xb00, 0xb00, 0x666, 0xb00,
        0xfff, 0xfff, 0xfff, 0xfff,
        0x666, 0x666, 0x566, 0xb00,
        0xb00, 0xb00, 0xfff, 0x666},

        {0xb00, 0xb00, 0x666, 0xfff,
        0xfff, 0xfff, 0xfff, 0xfff,
        0xb00, 0xfff, 0x666, 0xfff,
        0xfff, 0xfff, 0xfff, 0x666},

    };

const pixel_t game_o[2][16] = {
